...
function Signup(props) {
    ...
    async function submit() {
        ...
        const tempVal= await props.signUp(email, pwd);
        props.setCurrentStatus(tempVal);
    ...
    return (
        <div className='signupForm'>
            <form action="#">
                <div onClick={()=>props.setSignup(false)} className="closeButton">
                ...
                <button className='signinButton' onClick={submit}>Submit</button>
            </form>
        </div>
    )
}
